...
const Carousel = () => (
    ...
    <div id="carouselExampleSlidesOnly" className="carousel slide carousel-fade" data-ride="carousel" data-interval='5000'>
        <div className="carousel-inner">
            ...
            <div className="carousel-item active jumbotron text-center" id="slide1" style={jumbotronOneStyle} >
                ...
                <p>Street signs and handwritten letters alike become accessible at the push of a smartphone's camera button.</p>
            </div>
